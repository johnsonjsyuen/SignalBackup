...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsUploadHistory = new HashMap<String, TableInfo.Column>(8);
        _columnsUploadHistory.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUploadHistory.put("timestamp", new TableInfo.Column("timestamp", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUploadHistory.put("fileName", new TableInfo.Column("fileName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUploadHistory.put("fileSizeBytes", new TableInfo.Column("fileSizeBytes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUploadHistory.put("status", new TableInfo.Column("status", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUploadHistory.put("errorMessage", new TableInfo.Column("errorMessage", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoUploadHistory.equals(_existingUploadHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "upload_history(com.johnsonyuen.signalbackup.data.local.entity.UploadHistoryEntity).\n"
                  + " Expected:\n" + _infoUploadHistory + "\n"
                  + " Found:\n" + _existingUploadHistory);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "upload_history");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `upload_history`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(UploadHistoryDao.class, UploadHistoryDao_Impl.getRequiredConverters());
  ...
  @Override
  public UploadHistoryDao uploadHistoryDao() {
    if (_uploadHistoryDao != null) {
      return _uploadHistoryDao;
    } else {
      synchronized(this) {
        if(_uploadHistoryDao == null) {
          _uploadHistoryDao = new UploadHistoryDao_Impl(this);
        }
        return _uploadHistoryDao;
      }
    }
